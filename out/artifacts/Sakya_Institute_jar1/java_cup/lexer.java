 ...
 *  the JavaCup specification.  This scanner reads characters from the input
 *  stream and returns integers corresponding to the terminal 
...
public class lexer {
  ...
  public static void emit_error(String message)
    {
      System.err.println(Main.inFileName + ":" + current_line + ":" + current_position +
			 ": Error: JavaCUP: " + message);
      error_count++;
    }
